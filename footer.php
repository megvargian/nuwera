                        ...
                        <ul class="d-flex justify-content-center align-items-center flex-wrap">
                            <li class="mr-2">
                                <a href="https://www.youtube.com/@nuwera" target="_blank">
                                    <svg style="width: 40px;" class="e-font-icon-svg e-fab-youtube" viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="mr-2">
                                <a href="https://www.facebook.com/nuweraofficial" target="_blank">
                                    <svg style="width: 40px;" class="e-font-icon-svg e-fab-facebook" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="mr-2">
                                <a href="https://open.spotify.com/artist/3xnkIvYYVGsB934bfGTv9n" target="_blank">
                                    <svg style="width: 40px;" class="e-font-icon-svg e-fab-spotify" viewBox="0 0 496 512" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="mr-2">
                                <a href="https://www.tiktok.com/@nuweraa" target="_blank">
                                    <svg style="width: 40px;" class="e-font-icon-svg e-fab-tiktok" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="mr-2">
                                <a href="https://www.instagram.com/nnuwera/" target="_blank">
                                    <svg style="width: 40px;" class="e-font-icon-svg e-fab-instagram" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
